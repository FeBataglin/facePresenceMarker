(function (global, factory) {
    ...
    (global = global || self, factory((global['po-ui'] = global['po-ui'] || {}, global['po-ui']['ng-templates'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.ngComponents, global.ng.router, global.ng.common.http, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, common, forms, ngComponents, router, http, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PoModalPasswordRecoveryModule = /** @class */ (function () {
        ...
        PoModalPasswordRecoveryModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, forms.FormsModule, ngComponents.PoFieldModule, ngComponents.PoModalModule],
                ...
                providers: [ngComponents.PoI18nPipe, PoModalPasswordRecoveryService]
            })
    ...
    var PoPageBackgroundModule = /** @class */ (function () {
        ...
        PoPageBackgroundModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, forms.FormsModule, router.RouterModule, ngComponents.PoDividerModule, ngComponents.PoFieldModule],
    ...
    var PoPageBlockedUserModule = /** @class */ (function () {
        ...
        PoPageBlockedUserModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, router.RouterModule, ngComponents.PoModule, PoPageBackgroundModule],
    ...
    var PoPageChangePasswordBaseComponent = /** @class */ (function () {
        ...
        __decorate([
            core.Input('p-hide-current-password'),
            __metadata("design:type", Boolean),
            __metadata("design:paramtypes", [Boolean])
    ...
    var PoPageChangePasswordComponent = /** @class */ (function (_super) {
        ...
        PoPageChangePasswordComponent.ctorParameters = function () { return [
            ...
            { type: ngComponents.PoComponentInjectorService },
            { type: core.ViewContainerRef }
        ]; };
        __decorate([
            core.ViewChild(ngComponents.PoModalComponent, { static: true }),
            __metadata("design:type", ngComponents.PoModalComponent)
        ], PoPageChangePasswordComponent.prototype, "modal", void 0);
        __decorate([
            core.ViewChild('pageChangePassword', { read: core.ViewContainerRef, static: true }),
            __metadata("design:type", core.ViewContainerRef)
        ], PoPageChangePasswordComponent.prototype, "pageChangePassword", void 0);
        __decorate([
            core.ViewChild('passwordForm', { read: forms.NgForm, static: true }),
            __metadata("design:type", forms.NgForm)
        ...
        PoPageChangePasswordComponent = __decorate([
            ...
            __metadata("design:paramtypes", [router.ActivatedRoute,
                ...
                router.Router,
                PoPageChangePasswordService,
                ngComponents.PoComponentInjectorService,
    ...
    var PoPageChangePasswordModule = /** @class */ (function () {
        ...
        PoPageChangePasswordModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, forms.FormsModule, router.RouterModule, ngComponents.PoModule, PoPageBackgroundModule],
    ...
    var PoPageDynamicService = /** @class */ (function () {
        function PoPageDynamicService(http$1, notification, languageService) {
            this.http = http$1;
        ...
        PoPageDynamicService.ctorParameters = function () { return [
            ...
            { type: ngComponents.PoLanguageService }
        ]; };
        PoPageDynamicService.ɵprov = core.ɵɵdefineInjectable({ factory: function PoPageDynamicService_Factory() { return new PoPageDynamicService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(ngComponents.PoNotificationService), core.ɵɵinject(ngComponents.PoLanguageService)); }, token: PoPageDynamicService, providedIn: "root" });
        PoPageDynamicService = __decorate([
            core.Injectable({
                providedIn: 'root'
            }),
            __metadata("design:paramtypes", [http.HttpClient,
                ngComponents.PoNotificationService,
                ngComponents.PoLanguageService])
        ], PoPageDynamicService);
        return PoPageDynamicService;
    }());

    var PoPageDynamicDetailActionsService = /** @class */ (function () {
        function PoPageDynamicDetailActionsService(http$1) {
            this.http = http$1;
            this.headers = new http.HttpHeaders({
                'X-PO-SCREEN-LOCK': 'true'
            });
        ...
        PoPageDynamicDetailActionsService.ɵprov = core.ɵɵdefineInjectable({ factory: function PoPageDynamicDetailActionsService_Factory() { return new PoPageDynamicDetailActionsService(core.ɵɵinject(http.HttpClient)); }, token: PoPageDynamicDetailActionsService, providedIn: "root" });
    ...
    var PoPageCustomizationService = /** @class */ (function () {
        ...
        PoPageCustomizationService.ɵprov = core.ɵɵdefineInjectable({ factory: function PoPageCustomizationService_Factory() { return new PoPageCustomizationService(core.ɵɵinject(http.HttpClient)); }, token: PoPageCustomizationService, providedIn: "root" });
    ...
    var PoPageDynamicDetailComponent = /** @class */ (function () {
        ...
        PoPageDynamicDetailComponent.prototype.openEdit = function (action) {
            ...
            this.subscriptions.push(this.poPageDynamicDetailActionsService
                ...
                .pipe(operators.switchMap(function (beforeEditResult) {
        ...
        PoPageDynamicDetailComponent.prototype.loadOptionsOnInitialize = function (onLoad) {
            var _this = this;
            if (onLoad) {
                return this.getPoDynamicPageOptions(onLoad).pipe(operators.tap(function (responsePoOption) {
        ...
        PoPageDynamicDetailComponent.ctorParameters = function () { return [
            ...
            { type: router.ActivatedRoute },
            { type: ngComponents.PoNotificationService },
            { type: ngComponents.PoDialogService },
        ...
        PoPageDynamicDetailModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    forms.FormsModule,
                    router.RouterModule,
                    ngComponents.PoDynamicModule,
                    ngComponents.PoModalModule,
                    ngComponents.PoPageModule,
                    ngComponents.PoWidgetModule,
                    PoPageDynamicModule
                ],
    ...
    var PoPageDynamicEditActionsService = /** @class */ (function () {
        function PoPageDynamicEditActionsService(http$1) {
            this.http = http$1;
            this.headers = new http.HttpHeaders({
                'X-PO-SCREEN-LOCK': 'true'
            });
        ...
        PoPageDynamicEditActionsService.ɵprov = core.ɵɵdefineInjectable({ factory: function PoPageDynamicEditActionsService_Factory() { return new PoPageDynamicEditActionsService(core.ɵɵinject(http.HttpClient)); }, token: PoPageDynamicEditActionsService, providedIn: "root" });
    ...
    var PoPageDynamicEditComponent = /** @class */ (function () {
        ...
        __decorate([
            ...
            __metadata("design:type", ngComponents.PoDynamicFormComponent)
        ], PoPageDynamicEditComponent.prototype, "dynamicForm", void 0);
        __decorate([
            core.ViewChild('gridDetail'),
            __metadata("design:type", ngComponents.PoGridComponent)
        ...
        PoPageDynamicEditModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    forms.FormsModule,
                    router.RouterModule,
                    ngComponents.PoButtonModule,
                    ngComponents.PoDividerModule,
                    ngComponents.PoDynamicModule,
                    ngComponents.PoGridModule,
                    ngComponents.PoPageModule,
                    ngComponents.PoWidgetModule,
                    PoPageDynamicModule
                ],
    ...
    var PoAdvancedFilterBaseComponent = /** @class */ (function () {
        ...
        __decorate([
            core.Input('p-filters'),
            __metadata("design:type", Array),
            __metadata("design:paramtypes", [Array])
        ], PoAdvancedFilterBaseComponent.prototype, "filters", null);
        __decorate([
            ngComponents.InputBoolean(),
            core.Input('p-keep-filters'),
            __metadata("design:type", Boolean)
    ...
    var PoAdvancedFilterComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(ngComponents.PoDynamicFormComponent, { static: true }),
            __metadata("design:type", ngComponents.PoDynamicFormComponent)
    ...
    var PoPageDynamicSearchComponent = /** @class */ (function (_super) {
        ...
        PoPageDynamicSearchComponent.prototype.getFilterValueToDisclaimer = function (field, value) {
            if (field.type === ngComponents.PoDynamicFieldType.Date) {
        ...
        __decorate([
            core.ViewChild(PoAdvancedFilterComponent, { static: true }),
    ...
    var PoPageDynamicTableActionsService = /** @class */ (function () {
        function PoPageDynamicTableActionsService(http$1) {
            this.http = http$1;
            this.headers = new http.HttpHeaders({
                'X-PO-SCREEN-LOCK': 'true'
            });
        ...
        PoPageDynamicTableActionsService.ɵprov = core.ɵɵdefineInjectable({ factory: function PoPageDynamicTableActionsService_Factory() { return new PoPageDynamicTableActionsService(core.ɵɵinject(http.HttpClient)); }, token: PoPageDynamicTableActionsService, providedIn: "root" });
    ...
    var PoPageDynamicTableComponent = /** @class */ (function (_super) {
        ...
        PoPageDynamicTableComponent.prototype.getOrderParam = function (sortedColumn) {
            ...
            if (type === ngComponents.PoTableColumnSortType.Descending) {
        ...
        PoPageDynamicTableComponent.prototype.remove = function (item, actionRemove, actionBeforeRemove) {
            ...
            this.subscriptions.add(this.poPageDynamicTableActionsService
                ...
                .pipe(operators.switchMap(function (beforeRemove) {
        ...
        PoPageDynamicTableComponent.prototype.loadDataFromAPI = function () {
            ...
            if (Object.keys(initialFilters).length) {
                ...
                this.subscriptions.add(rxjs.concat(metadata$, data$).subscribe());
            }
        };
    ...
    var PoPageJobSchedulerComponent = /** @class */ (function (_super) {
        ...
        PoPageJobSchedulerComponent.prototype.nextStep = function (stepNumber) {
            ...
            if (steps) {
                steps.status = ngComponents.PoStepperStatus.Done;
            }
        };
        ...
        PoPageJobSchedulerComponent.prototype.resetJobSchedulerForm = function () {
            ...
            setTimeout(function () {
                ...
                _this.steps.forEach(function (step) {
                    step.status = ngComponents.PoStepperStatus.Default;
                });
                _this.jobSchedulerActions = __spread(_this.nextPageActions);
            });
        };
        ...
        __decorate([
            core.ViewChild('schedulerExecution', { static: true }),
            __metadata("design:type", Object)
        ], PoPageJobSchedulerComponent.prototype, "schedulerExecution", void 0);
        __decorate([
            core.ViewChild('schedulerParameters'),
            __metadata("design:type", Object)
    ...
    var PoPageJobSchedulerSummaryComponent = /** @class */ (function () {
        function PoPageJobSchedulerSummaryComponent(datePipe) {
            ...
            this.infoOrientation = ngComponents.PoInfoOrientation.Horizontal;
        ...
        PoPageJobSchedulerModule = __decorate([
            core.NgModule({
                ...
                imports: [
                    ...
                    forms.FormsModule,
                    ngComponents.PoButtonModule,
                    ngComponents.PoContainerModule,
                    ngComponents.PoDialogModule,
                    ngComponents.PoDividerModule,
                    ngComponents.PoDynamicModule,
                    ngComponents.PoFieldModule,
                    ngComponents.PoInfoModule,
                    ngComponents.PoPageModule,
                    ngComponents.PoStepperModule,
                    ngComponents.PoWidgetModule
                ],
    ...
    var PoPageLoginComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild('loginForm', { read: forms.NgForm, static: true }),
            __metadata("design:type", forms.NgForm)
        ], PoPageLoginComponent.prototype, "loginForm", void 0);
        __decorate([
            core.ViewChild('pageLogin', { read: core.ViewContainerRef, static: true }),
            __metadata("design:type", core.ViewContainerRef)
    ...
    var PoPageLoginModule = /** @class */ (function () {
        ...
        PoPageLoginModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, forms.FormsModule, router.RouterModule, PoPageBackgroundModule, ngComponents.PoModule],
