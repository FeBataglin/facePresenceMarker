...
var PoComboComponent = /** @class */ (function (_super) {
    ...
    PoComboComponent.prototype.initInputObservable = function () {
        var _this = this;
        if (this.service) {
            var keyupObservable = fromEvent(this.inputElement.nativeElement, 'keyup').pipe(filter(function (e) { return _this.isValidCharacterToSearch(e.keyCode); }), map(function (e) { return e.currentTarget.value; }), distinctUntilChanged(), tap(function () {
